...
namespace NetAudio
{
    ...
    /// </summary>
    public class IMp3FileReader : WaveStream
    {
        ...
        public IMp3FileReader(string mp3FileName)
        ...
        public IMp3FileReader(string mp3FileName, FrameDecompressorBuilder frameDecompressorBuilder)
        ...
        public IMp3FileReader(Stream inputStream)
        ...
        /// <param name="inputStream">The incoming stream containing MP3 data</param>
        /// <param name="frameDecompressorBuilder">Factory method to build a frame decompressor</param>
        public IMp3FileReader(Stream inputStream, FrameDecompressorBuilder frameDecompressorBuilder)
        {
        ...
        {
            return Mp3WaveFormat.SampleRate;
        }
        ...
        public byte[] ReadNextFrameToBytes(out int index)
        {
            ...
            index = tocIndex;
            byte[] data = new byte[tableOfContents[tocIndex].ByteCount];
            mp3Stream.Position = tableOfContents[tocIndex].FilePosition;
            mp3Stream.Read(data, 0, data.Length);
            tocIndex++;
            return data;
        }
